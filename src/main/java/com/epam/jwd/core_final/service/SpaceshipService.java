...
public interface SpaceshipService {
    ...
    Spaceship updateSpaceshipDetails(Spaceship olsSpaceship, Spaceship newSpaceship);
    ...
    Spaceship createSpaceship(Spaceship spaceship) throws EntityIsNotToBeCreatedException;
}
